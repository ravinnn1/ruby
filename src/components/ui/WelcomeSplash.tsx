  ...
  return (
    ...
    >
      ...
      <div className="absolute top-1/4 left-1/4 w-80 h-80 rounded-full pointer-events-none"
        style={{ background: 'radial-gradient(circle, rgba(248,200,220,0.3) 0%, transparent 70%)', animation: 'rubyOrb1 4s ease-in-out infinite' }} />
      <div className="absolute bottom-1/4 right-1/4 w-64 h-64 rounded-full pointer-events-none"
        style={{ background: 'radial-gradient(circle, rgba(168,198,134,0.15) 0%, transparent 70%)', animation: 'rubyOrb2 5s ease-in-out infinite' }} />
      <div className="absolute top-1/3 right-1/3 w-48 h-48 rounded-full pointer-events-none"
        style={{ background: 'radial-gradient(circle, rgba(155,17,30,0.08) 0%, transparent 70%)', animation: 'rubyOrb1 6s 1s ease-in-out infinite' }} />
      ...
      {[
        ...
        <span key={i} className="ruby-splash-emoji" style={{ left: item.l, top: item.t, animation: item.a }}>
          {item.e}
        </span>
      ))}
      ...
      <div className="text-center px-8 max-w-md relative z-10">
        ...
        >
          <p className="text-2xl md:text-3xl font-bold leading-snug" style={{ color: '#9B111E', fontFamily: 'Georgia, serif' }}>You are talented.</p>
          <p className="text-2xl md:text-3xl font-bold leading-snug" style={{ color: '#C94C63', fontFamily: 'Georgia, serif' }}>You are lovely.</p>
          <p className="text-2xl md:text-3xl font-bold leading-snug" style={{ color: '#B76E79', fontFamily: 'Georgia, serif' }}>You are loved.</p>
          <p className="text-2xl md:text-3xl font-bold leading-snug" style={{ color: '#6F8F5F', fontFamily: 'Georgia, serif' }}>You are enough.</p>
        </motion.div>
